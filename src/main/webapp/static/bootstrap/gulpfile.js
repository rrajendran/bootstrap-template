...
// Copy vendor libraries from /bower_components int{{ request.contextPath }}/static/bootstrap/vendor
gulp.task('copy', function() {
    gulp.src(['bower_components/bootstr{{ request.contextPath }}/static/bootstrap/dist/**/*', '!**/npm.js', '!**/bootstrap-theme.*', '!**/*.map'])
    ...
    gulp.src(['bower_components/jque{{ request.contextPath }}/static/bootstrap/dist/jquery.js', 'bower_components/jque{{ request.contextPath }}/static/bootstrap/dist/jquery.min.js'])
        .pipe(gulp.dest('vendor/jquery'))

    gulp.src(['bower_components/metisMe{{ request.contextPath }}/static/bootstrap/dist/*'])
